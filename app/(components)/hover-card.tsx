    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    opacity,
                    background: `radial-gradient(600px circle at ${position.x}px ${position.y}px, rgba(122,182,255,.18), transparent 35%)`,
                }}
            />
            ...
            <CardHeader className="pb-6">
                ...
                <CardDescription className="text-lg text-gray-400">{props.description}</CardDescription>
            </CardHeader>
